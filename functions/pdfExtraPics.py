...
def pdf2pic(path, pic_path):
    ...
    for i in range(1, lenXREF):
        ...
        img_name=random.sample('1234567890abcdefghijklmnopqrstuvwxyz-',32)
        new_name = "{}.png".format("".join(img_name)) # 生成图片的名称
...
if __name__=='__main__':
    # path = r"E:\有道笔记\【02】编程知识点\编程语言\docker\docker.pdf"
    # pic_path = r'E:\有道笔记\【02】编程知识点\编程语言\docker'
    # # 创建保存图片的文件夹
